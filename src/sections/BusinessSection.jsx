      ...
      <div className="container-premium grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div>
          <SectionTitle
            ...
            text="Мы помогаем не просто переехать, а выстроить рабочую систему: юридическое лицо, налоговый номер и кабинет, регистрации в госорганах и иммиграции, банковские счета, платежные инструменты, офис, команда, налоги и документы."
          />
