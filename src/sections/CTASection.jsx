          ...
          <div className="grid gap-0 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="relative p-5 sm:p-10 lg:p-12">
              ...
              <div className="relative">
                ...
                />
                <Reveal delay={140} className="mt-8 flex flex-col gap-4 sm:mt-9 sm:flex-row lg:flex-col xl:flex-row">
                  <a href="#lead" className="premium-button w-full bg-gold text-graphite hover:bg-ivory sm:w-auto lg:w-full xl:w-auto">
            ...
            <Reveal delay={180} className="border-t border-white/10 p-5 sm:p-8 lg:border-l lg:border-t-0">
              <LeadForm />
            </Reveal>
          </div>
        </div>
